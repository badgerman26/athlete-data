...
class IntervalsSync:
    ...
    def _calculate_derived_metrics(self, activities_7d: List[Dict], activities_28d: List[Dict],
        ...
        rhr_values_7d = [(w.get("avgSleepingHR") or w.get("restingHR")) for w in wellness_7d if (w.get("avgSleepingHR") or w.get("restingHR"))]
        ...
        rhr_values_ext = [(w.get("avgSleepingHR") or w.get("restingHR")) for w in wellness_extended if (w.get("avgSleepingHR") or w.get("restingHR"))]
        ...
        latest_rhr = (wellness_7d[-1].get("avgSleepingHR") or wellness_7d[-1].get("restingHR")) if wellness_7d else None
    ...
    def _get_phase_modifiers(self, phase: Optional[str], race_week_active: bool) -> Dict:
        ...
        modifiers = {
            "Build":       {"amber_threshold": 3, "tsb_amber": -40, "tighten_red": False, "modifier_applied": "build_loosened"},
    ...
    def _compute_readiness_decision(self, derived_metrics: Dict, alerts: List[Dict],
        ...
        if tsb is not None and tsb < -40 and hrv_delta_pct is not None and hrv_delta_pct < -10:
        ...
        if tsb is not None and tsb < -35 and hrv_delta_pct is not None and hrv_delta_pct < -10:
